...
summary_line2 = paste("Over the past week the average daily deaths was ", avg_daily_death_last_7days, ". That rate would result in ", annual_deaths_estimate_last_7days, " deaths annually.", sep="")
writeLines(summary_line2)


summary_line3 = paste("Over the past two weeks the average daily deaths was ", avg_daily_death_last_14days, ". That rate would result in ", annual_deaths_estimate_last_14days, " deaths annually.", sep="")
writeLines(summary_line3)

summary_line4 = paste("Over the past three weeks the average daily deaths was ", avg_daily_death_last_21days, ". That rate would result in ", annual_deaths_estimate_last_21days, " deaths annually.", sep="")
writeLines(summary_line4)

summary_line5 = paste("Over the past four weeks the average daily deaths was ", avg_daily_death_last_28days, ". That rate would result in ", annual_deaths_estimate_last_28days, " deaths annually.", sep="")
