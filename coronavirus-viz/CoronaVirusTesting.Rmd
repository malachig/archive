...
df <- lapply(data_us_daily, function(day) # Loop through each "day"
{
  ...
  data.frame(matrix(unlist(day), ncol=11, byrow=T))
})
...
#add column names
names(data_us_daily) = c("Date","StatesTracked","Positive","Negative","Pos+Neg","Pending","Hospitalized","Deaths","TotalTests","DateChecked","TotalTestResults")
