...
**Figure 4**. The number of **new** positive cases reported each day are summarized below. Dotted line indicates the high water mark.
...
p = p + scale_x_date(date_breaks = date_breaks, date_labels =  "%a %b %d")
p = p + scale_y_continuous(labels = scales::comma_format(big.mark = ',', decimal.mark = '.'))
p = p + geom_hline(yintercept=max_new_positives, color="red", lty=2, lwd=0.2)
print(p)
```
...
**Figure 8**. Number of new deaths observed each day. Dotted line indicates the high water mark. Pretty self explanatory. We want this to trend downwards... 
...
p = p + scale_x_date(date_breaks = date_breaks, date_labels =  "%a %b %d") 
p = p + scale_y_continuous(labels = scales::comma_format(big.mark = ',', decimal.mark = '.'))
p = p + geom_hline(yintercept=max_new_deaths, color="red", lty=2, lwd=0.2)
print(p)
```
