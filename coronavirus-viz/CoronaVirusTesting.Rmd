...
#add column names
names(data_us_daily) = c("Date","StatesTracked","Positive","Negative","Pos+Neg","Pending","Hospitalized","Deaths","TotalTests","Hash","DateChecked","TotalTestResults","deathIncrease","hospitalizedIncrease","negativeIncrease","positiveIncrease","totalTestResultsIncrease")
...
p = p + scale_x_date(date_breaks = "1 day", date_labels =  "%a %b %d") 
...
total_tests = prettyNum(data_us_daily[last_day,"TotalTests"], big.mark=",",scientific=FALSE)
