...
CairoJPEG(filename="ExonSizes.jpeg", width=700, height=700, quality=100, pointsize=12, bg="white")
...
CairoJPEG(filename="ExonSizes_95percentile.jpeg", width=700, height=700, quality=100, pointsize=12, bg="white")
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", min, " ", units, sep=""),
...
mean = mean(data)
max = max(data)
CairoJPEG(filename="ExonsPerGene.jpeg", width=700, height=700, quality=100, pointsize=12, bg="white")
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", min, " ", units, sep=""),
...
mean = mean(data)
max = max(data)
CairoJPEG(filename="ExonsPerGene_95percentile.jpeg", width=700, height=700, quality=100, pointsize=12, bg="white")
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", min, " ", units, sep=""),
...
mean = mean(data)
max = max(data)
CairoJPEG(filename="GeneSizes.jpeg", width=700, height=700, quality=100, pointsize=12, bg="white")
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", min, " ", units, sep=""),
...
mean = mean(data)
max = max(data)
CairoJPEG(filename="GeneSizes_95percentile.jpeg", width=700, height=700, quality=100, pointsize=12, bg="white")
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", min, " ", units, sep=""),
...
CairoJPEG(filename="GeneTypes.jpeg", width=1000, height=1000, quality=100, pointsize=12, bg="white")
...
CairoJPEG(filename="GeneEvidence.jpeg", width=700, height=700, quality=100, pointsize=12, bg="white")
par(bg=bg, font.main = 2, font.lab = 2); 
...
CairoJPEG(filename="GeneChromosomes.jpeg", width=700, height=700, quality=100, pointsize=12, bg="white")
par(bg=bg, font.main = 2, font.lab = 2); 
pie(x=table(data), xlab=x_label, col=rainbow(length(table(data))), main=title, col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0) 
zz=dev.off()
...
mean = mean(data)
max = max(data)
CairoJPEG(filename="ExonCoverage.jpeg", width=700, height=700, quality=100, pointsize=12, bg="white")
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
...
mean = mean(data)
max = max(data)
CairoJPEG(filename="ExonCoverage_95percentile.jpeg", width=700, height=700, quality=100, pointsize=12, bg="white")
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", round(min, digits=4), " ", units, sep=""),
...
mean = mean(data)
max = max(data)
CairoJPEG(filename="GeneReads.jpeg", width=700, height=700, quality=100, pointsize=12, bg="white")
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", min, " ", units, sep=""),
...
mean = mean(data)
max = max(data)
CairoJPEG(filename="GeneReads_95percentile.jpeg", width=700, height=700, quality=100, pointsize=12, bg="white")
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", round(min, digits=4), " ", units, sep=""),
...
CairoJPEG(filename="PercentGeneCoverage_1x-500x.jpeg", width=700, height=700, quality=100, pointsize=12, bg="white")
cols=rainbow(9)
...
mean = mean(data)
max = max(data)
CairoJPEG(filename="GeneCoverage.jpeg", width=700, height=700, quality=100, pointsize=12, bg="white")
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", round(min, digits=4), " ", units, sep=""),
...
mean = mean(data)
max = max(data)
CairoJPEG(filename="GeneCoverage_95percentile.jpeg", width=700, height=700, quality=100, pointsize=12, bg="white")
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", round(min, digits=4), " ", units, sep=""),
...
x_label = "X coverage cutoff"
y_label = paste("Percent Gene Coverage (n = ", prettyNum(length(data1), big.mark=",")," genes)", sep="")
CairoJPEG(filename="PercentGeneCoverage_1x-500x_Expressed.jpeg", width=700, height=700, quality=100, pointsize=12, bg="white")
cols=rainbow(9)
par(bg=bg, font.main = 2, font.lab = 2); boxplot(x = list(data1,data2,data3,data4,data5,data6), names=names, main=title, xlab=x_label, ylab=y_label, col=cols[1:6], col.main = "black", col.lab = gray(.1), cex.main = 1.5, cex.lab = 1.4, cex.axis=1.4)
zz=dev.off();
