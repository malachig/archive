...
Cairo(width=700, height=700, file="ExonSizes.svg", type="svg", pointsize=12, bg="white", units="px", dpi=72)
...
Cairo(width=700, height=700, file="ExonSizes_95percentile.svg", type="svg", pointsize=12, bg="white", units="px", dpi=72)
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", min, " ", units, sep=""),
...
mean = mean(data)
max = max(data)
Cairo(width=700, height=700, file="ExonsPerGene.svg", type="svg", pointsize=12, bg="white", units="px", dpi=72)
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", min, " ", units, sep=""),
...
mean = mean(data)
max = max(data)
Cairo(width=700, height=700, file="ExonsPerGene_95percentile.svg", type="svg", pointsize=12, bg="white", units="px", dpi=72)
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", min, " ", units, sep=""),
...
mean = mean(data)
max = max(data)
Cairo(width=700, height=700, file="GeneSizes.svg", type="svg", pointsize=12, bg="white", units="px", dpi=72)
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", min, " ", units, sep=""),
...
mean = mean(data)
max = max(data)
Cairo(width=700, height=700, file="GeneSizes_95percentile.svg", type="svg", pointsize=12, bg="white", units="px", dpi=72)
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", min, " ", units, sep=""),
...
Cairo(width=1000, height=1000, file="GeneTypes.svg", type="svg", pointsize=12, bg="white", units="px", dpi=72)
...
Cairo(width=700, height=700, file="GeneEvidence.svg", type="svg", pointsize=12, bg="white", units="px", dpi=72)
par(bg=bg, font.main = 2, font.lab = 2); 
...
Cairo(width=700, height=700, file="GeneChromosomes.svg", type="svg", pointsize=12, bg="white", units="px", dpi=72)
par(bg=bg, font.main = 2, font.lab = 2); 
pie(x=table(data), xlab=x_label, col=rainbow(length(table(data))), main=title, col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0) 
zz=dev.off()
...
ss=summary(exon_data[,"Average_Coverage_RAW"])  #Dynamic range of exon expression levels is ~10^5
units = "X"
...
mean = mean(data)
max = max(data)
Cairo(width=700, height=700, file="ExonCoverage.svg", type="svg", pointsize=12, bg="white", units="px", dpi=72)
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
...
mean = mean(data)
max = max(data)
Cairo(width=700, height=700, file="ExonCoverage_95percentile.svg", type="svg", pointsize=12, bg="white", units="px", dpi=72)
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", round(min, digits=4), " ", units, sep=""),
...
#H.) GENE READ COUNT
ss=summary(gene_data[,"Read_Count"])  #Dynamic range of gene read counts is : 1 read - 2.1 million reads (for H19 in MIP101 cells...)
units = "Reads"
...
mean = mean(data)
max = max(data)
Cairo(width=700, height=700, file="GeneReads.svg", type="svg", pointsize=12, bg="white", units="px", dpi=72)
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", min, " ", units, sep=""),
...
mean = mean(data)
max = max(data)
Cairo(width=700, height=700, file="GeneReads_95percentile.svg", type="svg", pointsize=12, bg="white", units="px", dpi=72)
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", round(min, digits=4), " ", units, sep=""),
...
Cairo(width=700, height=700, file="PercentGeneCoverage_1x-500x.svg", type="svg", pointsize=12, bg="white", units="px", dpi=72)
cols=rainbow(9)
...
ss=summary(gene_data[,"Average_Coverage_RAW"])  #Dynamic range of gene expression levels is 0 to 10^5
units = "X"
...
mean = mean(data)
max = max(data)
Cairo(width=700, height=700, file="GeneCoverage.svg", type="svg", pointsize=12, bg="white", units="px", dpi=72)
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", round(min, digits=4), " ", units, sep=""),
...
mean = mean(data)
max = max(data)
Cairo(width=700, height=700, file="GeneCoverage_95percentile.svg", type="svg", pointsize=12, bg="white", units="px", dpi=72)
par(bg=bg, font.main = 2, font.lab = 2); hist(x=data, main=title, xlab=x_label, ylab=y_label, col="blue", col.main = "black", col.lab = gray(.1), cex.main = 1.4, cex.lab = 1.2, cex.axis=1.0, breaks=100)
abline(v=median, col="red", lty=2, lwd=2)
abline(v=mean, col="orange", lty=2, lwd=2)
legend_text = c(paste("Min. = ", round(min, digits=4), " ", units, sep=""),
...
x_label = "X coverage cutoff"
y_label = paste("Percent Gene Coverage (n = ", prettyNum(length(data1), big.mark=",")," genes)", sep="")
Cairo(width=700, height=700, file="PercentGeneCoverage_1x-500x_Expressed.svg", type="svg", pointsize=12, bg="white", units="px", dpi=72)
cols=rainbow(9)
par(bg=bg, font.main = 2, font.lab = 2); boxplot(x = list(data1,data2,data3,data4,data5,data6), names=names, main=title, xlab=x_label, ylab=y_label, col=cols[1:6], col.main = "black", col.lab = gray(.1), cex.main = 1.5, cex.lab = 1.4, cex.axis=1.4)
zz=dev.off();
