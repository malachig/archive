...
#datafile1 = "/projects/malachig/alexa_seq/figures_and_stats/HS1362/temp/Average_Coverage_NORM1_joined.txt"
#datafile2 = "/projects/malachig/alexa_seq/figures_and_stats/HS1362/temp/Average_Coverage_RAW_joined.txt"
#datafile3 = "/projects/malachig/alexa_seq/figures_and_stats/HS1362/temp/Average_Coverage_NORM1_ER.txt"
#datafile4 = "/projects/malachig/alexa_seq/figures_and_stats/HS1362/temp/Average_Coverage_NORM1_SIR.txt"
#results_dir = "/projects/malachig/alexa_seq/figures_and_stats/HS1362/Expression_v53/"
#library_name = "HS1362"
...
svg_percentiles = "PercentilesPlot_Log2.svg"
Cairo(width=800, height=800, file=svg_percentiles, type="svg", pointsize=12, bg="white", units="px", dpi=72)
...
display_names = c("Gene","Transcript","Exon Region","Junction","Boundary", "Intron", "Active Intron Region","Silent Intron Region","Intergenic","Active Intergenic Region","Silent Intergenic Region");
temp_data=log2(data[display_types])
names(temp_data)=display_names

svg_boxplot_all_types = "ExpressionValues_NORM1_Log2_AllTypes_bplot.svg";
Cairo(width=1000, height=1000, file=svg_boxplot_all_types, type="svg", pointsize=12, bg="white", units="px", dpi=72)
par(font.main = 2, font.lab = 2, mar=(c(15, 4, 4, 2)+0.1))
...
svg_boxplot_all_types = "ExpressionValues_RAW_Log2_AllTypes_bplot.svg";
Cairo(width=1000, height=1000, file=svg_boxplot_all_types, type="svg", pointsize=12, bg="white", units="px", dpi=72)
par(font.main = 2, font.lab = 2, mar=(c(15, 4, 4, 2)+0.1))
...
svg_hist_all_types = "ExpressionValues_Log2_AllTypes_hist.svg";
Cairo(width=1920, height=1200, file=svg_hist_all_types, type="svg", pointsize=12, bg="white", units="px", dpi=72)
...
for (i in 1:length(data[1,])){
  filename = paste("ExpressionValue_Log2_hist_", names(data[i]), ".svg", sep="")
  Cairo(width=700, height=700, file=filename, type="svg", pointsize=12, bg="white", units="px", dpi=72)
...
filename = paste("ExonRegionVsGeneExpression_Log2.svg", sep="")
Cairo(width=700, height=700, file=filename, type="svg", pointsize=12, bg="white", units="px", dpi=72)
...
filename = paste("SilentIntronicVsGeneExpression_Log2.svg", sep="")
Cairo(width=700, height=700, file=filename, type="svg", pointsize=12, bg="white", units="px", dpi=72)
...
legend(legend_location, legend=legend_text, lty=c(1,2), lwd=c(2,2), col=c("black","black"))
zz=dev.off() 
