...
#results_dir = "/projects/malachig/solexa/figures_and_stats/HS04391/Expression_v53/"
...
jpeg_percentiles = "PercentilesPlot_Log2.jpeg"
CairoJPEG(filename=jpeg_percentiles, width=800, height=800, quality=100, pointsize=12, bg="white")
...
jpeg_boxplot_all_types = "ExpressionValues_NORM1_Log2_AllTypes_bplot.jpeg";
CairoJPEG(filename=jpeg_boxplot_all_types, width=1000, height=1000, quality=100, pointsize=12, bg="white")
...
jpeg_boxplot_all_types = "ExpressionValues_RAW_Log2_AllTypes_bplot.jpeg";
CairoJPEG(filename=jpeg_boxplot_all_types, width=1000, height=1000, quality=100, pointsize=12, bg="white")
par(font.main = 2, font.lab = 2, mar=(c(15, 4, 4, 2)+0.1))
...
jpeg_hist_all_types = "ExpressionValues_Log2_AllTypes_hist.jpeg";
CairoJPEG(filename=jpeg_hist_all_types, width=1920, height=1200, quality=100, pointsize=12, bg="white")
...
for (i in 1:length(data[1,])){
  filename = paste("ExpressionValue_Log2_hist_", names(data[i]), ".jpeg", sep="")
  CairoJPEG(filename=filename, width=700, height=700, quality=100, pointsize=12, bg="white")
  par(font.main = 2, font.lab = 2)
...
filename = paste("ExonRegionVsGeneExpression_Log2.jpeg", sep="")
CairoJPEG(filename=filename, width=700, height=700, quality=100, pointsize=12, bg="white")
...
filename = paste("SilentIntronicVsGeneExpression_Log2.jpeg", sep="")
CairoJPEG(filename=filename, width=700, height=700, quality=100, pointsize=12, bg="white")
