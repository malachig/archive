...
/***
*	Note:  Because the STL list iterator which I am using does not 
*	return const elements, I can not use const print methods.  I could 
*	solve this problem by using type casting of the variable that is derived 
*	from the iterator.  To me it seems simpler to just make sure that my print 
*	functions do not change data by coding them properly.  I tried the type casting
*	briefly but couldn't get it to work and ran out of time.  :( 
***/
...
Course::print() // const
{
	// Declare iterator for list and initialize to first element.
	...
	while (itr != dm_studentList.end())  // Until at end of list
	{
		...
		cout << endl;
		i++;
		itr++;	// Advance the iterator to the next element
	}
	cout << endl;
}
...
bool 
Course::remove_student(Student *s)
{
	// Declare iterator for list and initialize to first element.
	list<Student*>::iterator itr = dm_studentList.begin();
	list<Student*>::iterator next;  // For use with erase method
