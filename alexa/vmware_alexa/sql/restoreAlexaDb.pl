...
my @tables = qw (Gene Transcript Protein_feature External_id Exon TranscriptExon Probe Probe_set ProbeProbe_set GeneProbe Microarray ArraySpot MaskedGene Probe_negativeControl all_mrna all_est);
