...
print GREEN, "\n\tSpecify the full path to the directory containing pairfold executables using:  --pairfold_dir (eg. ~/MultiRNAFold-1.7_FILE/)", RESET;
...
print GREEN, "\n\nExample: createPairFoldBatch.pl  --master_probe_file=/home/user/alexa/ALEXA_version/unfiltered_probes/exonJunctionProbes.txt  --expected_probe_count=1234  --pairfold_dir=~/MultiRNAFold-1.7_FILE/  --folding_bin=~/alexa/Array_design/get_SimFold-PairFoldScores.pl  --temp_dir=/home/user/alexa/ALEXA_version/fold/  --batch_file=/home/user/alexa/ALEXA_version/batch_scripts/pairfold_ExonJunction.sh  --repair=no  --logfile=/home/user/alexa/ALEXA_version/logs/createPairFoldBatch_ExonJunction_LOG.txt\n\n", RESET;
