...
#Use this script along with 'parseMaskedGenes.pl' the do your own RepeatMasking of complete Ensembl gene sequences (including introns)
#Alternatively the ALEXA pipeline gets these masked sequences directly from EnsEMBL 
#    - where they are masked by RepeatMasker, Tandem Repeat Finder, and Dust
