...
#This script takes a raw data file as input and calculates log2 and DE values for all single probes
...
print GREEN, "\n\nExample: create_MTP_formatted_DataFiles.pl  --data_file=/home/malachig/AlternativeSplicing/Array_analysis/NimbleGen_Data/MIPvs5FUR_04Dec2006/AuxillaryData/PairData_formatted/Quantiles_TmBGC/All_hybes_withProbeInfo_BGC_Norm.txt  --out_dir=/home/malachig/AlternativeSplicing/Array_analysis/NimbleGen_Data/MIPvs5FUR_04Dec2006/AuxillaryData/Processed_data/Quantiles_TmBGC/MTP_formatted  --file_type=Standard\n\n", RESET;
...
sub parseProbeFile{
  ...
  while(<DATA>){
    ...
    #Skip Negative control probes for the Affy AO dataset because the probesets are too large
    if ($file_type eq "AO_affy"){
