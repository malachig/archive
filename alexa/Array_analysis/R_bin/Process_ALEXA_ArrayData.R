...
#var_stab_adjust_value = 16  #For the ALEXA paper, 16 was added to raw data to stabalize variance
var_stab_adjust_value = 4   #For comparison to WTSS data trying adding just 4
#var_stab_adjust_value = 1   #For comparison to WTSS data trying adding just 1

test = generate_BGC_values(data_complete, "MIP_EF_A", B_MIP_EF_A)
data_complete[,"MIP_EF_A_bgc"] = test + var_stab_adjust_value
test = generate_BGC_values(data_complete, "MIP_EF_B", B_MIP_EF_B)
data_complete[,"MIP_EF_B_bgc"] = test + var_stab_adjust_value
test = generate_BGC_values(data_complete, "MIP_GH_A", B_MIP_GH_A)
data_complete[,"MIP_GH_A_bgc"] = test + var_stab_adjust_value

test = generate_BGC_values(data_complete, "FUR_EF_A", B_FUR_EF_A)
data_complete[,"FUR_EF_A_bgc"] = test + var_stab_adjust_value
test = generate_BGC_values(data_complete, "FUR_EF_B", B_FUR_EF_B)
data_complete[,"FUR_EF_B_bgc"] = test + var_stab_adjust_value
test = generate_BGC_values(data_complete, "FUR_GH_A", B_FUR_GH_A)
data_complete[,"FUR_GH_A_bgc"] = test + var_stab_adjust_value
...
#write.table(new_data[,], file="All_hybes_withProbeInfo_BGC_plus16_Norm.txt", eol="\n", sep="\t", row.names=FALSE, quote=FALSE, na = "na")
write.table(new_data[,], file="All_hybes_withProbeInfo_BGC_plus4_Norm.txt", eol="\n", sep="\t", row.names=FALSE, quote=FALSE, na = "na")
#write.table(new_data[,], file="All_hybes_withProbeInfo_BGC_plus1_Norm.txt", eol="\n", sep="\t", row.names=FALSE, quote=FALSE, na = "na")
