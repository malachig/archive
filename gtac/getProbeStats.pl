...
$desired_columns{'linker_Non-TargetHits'}{name} = "Number of hits to linker sequences";
$desired_columns{'linker_Non-TargetHits'}{display_order} = 14;
$desired_columns{'linker_largestNon-TargetHitLength'}{name} = "Size of hits to linker sequences";
$desired_columns{'linker_largestNon-TargetHitLength'}{display_order} = 15;
$desired_columns{NimbleGenCycles}{name} = "NimbleGen Cycle Count";
$desired_columns{NimbleGenCycles}{display_order} = 16;
